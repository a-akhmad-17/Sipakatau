...
class UserSeeder extends Seeder
{
    public function run()
    {
        ...
        $bidangIds = [
            ...
            'SEKRETARIAT'     => 'b1d00004-beef-4a4a-98d0-fca32b8879f6',
        ];
        ...
        $users = [
            ...
            [
                'id'         => $uuidGen(),
                'username'   => 'kabid_wasbang',
                'password'   => password_hash('kabid123', PASSWORD_BCRYPT),
                'email'      => 'kabid.wasbang@sinjaikab.go.id',
                'role'       => 'kabid',
                'status'     => 'active',
            ...
            [
                'id'         => $uuidGen(),
                'username'   => 'kabid_poldagri',
                'password'   => password_hash('kabid123', PASSWORD_BCRYPT),
                'email'      => 'kabid.poldagri@sinjaikab.go.id',
                'role'       => 'kabid',
                'status'     => 'active',
            ...
            [
                'id'         => $uuidGen(),
                'username'   => 'kabid_ekososbud',
                'password'   => password_hash('kabid123', PASSWORD_BCRYPT),
                'email'      => 'kabid.ekososbud@sinjaikab.go.id',
                'role'       => 'kabid',
                'status'     => 'active',
            ...
            [
                'id'         => $uuidGen(),
                'username'   => 'kabid_sekretariat',
                'password'   => password_hash('kabid123', PASSWORD_BCRYPT),
                'email'      => 'kabid.sekretariat@sinjaikab.go.id',
                'role'       => 'kabid',
                'status'     => 'active',
